    ...
    <>
      ...
      <main className="inner-page">
        <div className="container">
          ...
          <blockquote>
            <strong>Note:</strong> This document was drafted with AI assistance and reviewed against
            Australian law as at June 2026. It is provided as a starting point and does not
            constitute legal advice. You should have this reviewed by a qualified Australian
            solicitor before relying on it commercially, particularly given that Debrief handles
            voice recordings and personal journal content.
          </blockquote>
