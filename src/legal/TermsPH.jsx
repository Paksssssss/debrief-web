...
// Standalone Terms of Service for Philippine users.
// ⚠️ Drafted with AI assistance as at June 2026. Not legal advice. Review by a Philippine DPA lawyer required.
export default function TermsPH() {
  return (
    <>
      ...
      <p className="updated">
        <em>
          ...
          It should be reviewed by a lawyer familiar with Philippine law before commercial reliance.
        </em>
      </p>
      ...
      <ul>
        ...
        <li>Have the legal capacity to enter into a binding agreement under Philippine law</li>
        <li>Not be prohibited from using the App under any applicable law</li>
      </ul>
      <p>
        If you are under 18, you are not permitted to create an account or use the App.
      </p>
      <p>
        Your use of the App as a Philippine user is also subject to the{' '}
        <strong>Data Privacy Act of 2012 (Republic Act No. 10173)</strong>. Our{' '}
        <Link to="/privacy?region=PH">Privacy Policy (Philippines)</Link> explains how we
        handle your personal information and what rights you have under the DPA.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://www.apple.com/legal/" target="_blank" rel="noopener noreferrer">Apple's Terms of Use</a>{' '}
          and{' '}
          <a href="https://www.apple.com/privacy/" target="_blank" rel="noopener noreferrer">Apple's Privacy Policy</a>.
        </li>
        <li>
      ...
      <p>
        ...
        <Link to="/privacy?region=PH">Privacy Policy (Philippines)</Link> explains how we
        collect, use, store, and protect your personal information, and what rights you have
        under the <strong>Data Privacy Act of 2012 (Republic Act No. 10173)</strong>. By
        using Debrief, you acknowledge that you have read and understood our Privacy Policy.
      </p>
      <p>
        For questions about your data or to exercise your rights under the DPA, contact our
      ...
      <p>
        ...
        and "as available" basis without any warranty, express or implied. We do not warrant that:
      </p>
      <ul>
      ...
      <p>
        Nothing in these Terms excludes or limits any rights you may have under applicable
        Philippine consumer protection law that cannot be lawfully excluded.
      </p>
      ...
      <ul>
        <li>
          ...
          capped at AUD $50 (or the equivalent in Philippine Peso at the time of the claim).
          Debrief is free — you pay nothing to use it. This is a limit on what we may owe
          you, not a fee you pay us.
        </li>
        <li>
      ...
      <ul>
        <li>Any liability that cannot be excluded by applicable Philippine law</li>
        <li>Personal injury or death caused by our negligence or wilful misconduct</li>
        <li>Fraud or fraudulent misrepresentation</li>
        <li>Liability arising from a violation of the Data Privacy Act of 2012</li>
      </ul>
      ...
      <p>
        ...
        <Link to="/privacy?region=PH">Privacy Policy (Philippines)</Link> (Section 10 — Data
      ...
      <p>
        ...
        These Terms are governed by the laws of Victoria, Australia, as the developer entity
        is based in Australia. You agree to submit to the non-exclusive jurisdiction of the
        courts of Victoria for the resolution of any contractual dispute. Nothing in this
        clause prevents either party from seeking urgent interlocutory or injunctive relief.
      </p>
      <p>
        <strong>Philippine data privacy rights:</strong> Notwithstanding the governing law
        clause above, Philippine users retain all rights granted under the{' '}
        <strong>Data Privacy Act of 2012 (RA 10173)</strong>, including the right to lodge a
      ...
      <p>
        ...
        illegal, or unenforceable under applicable law, that provision will be limited or
        eliminated to the minimum extent necessary, and the remaining provisions will remain
      ...
      <p>
        <strong>Entire agreement:</strong> These Terms and our Privacy Policy (Philippines)
        constitute the entire agreement between you and us regarding your use of Debrief, and
        supersede all prior agreements or understandings (whether written or oral) relating to
        the App.
      </p>
      ...
      <p className="updated"><em>Terms of Service v1.0 (Philippines) — Debrief — Voice Journal — June 2026</em></p>
    </>
  );
}
